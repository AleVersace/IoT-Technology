...
const String url = "http://10.0.0.11:8080";
const String id = "Yun1";
String broker = "";
String port = "0";
int flag = 0;
...
int postRequest() {
  ...
  p.addParameter("POST");
  p.addParameter("-d");
  p.addParameter(F("{\"id\":\"ID1\",\"ep\":{\"tmp\":\"/iot/13/tmp\",\"nos\":\"/iot/13/nos\",\"mov\":\"/iot/13/mov\",\"lcd\":\"/iot/13/a/d\",\"led\":\"/iot/13/a/l\",\"fan\":\"/iot/13/a/f\",\"rgb\":\"/iot/13/a/rgb\"}}"));
...
void getMQQTdata(const String& topic, const String& subtopic, const String& message) {
  ...
  else if (subtopic == "rgb") {
    int commaIndex = message.indexOf(',');
    int secondCommaIndex = message.indexOf(',', commaIndex + 1);
    String firstValue = message.substring(1, commaIndex);
